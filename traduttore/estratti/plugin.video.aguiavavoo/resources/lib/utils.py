...
def error_dialog(heading, message):
    ...
    xbmcgui.Dialog().ok(f"[COLORred]Águia [COLORwhite]Vavoo[/COLOR] - {heading}", message)
...
def notify(message, heading="[COLORred]Águia [COLORwhite]Vavoo[/COLOR]", icon=xbmcgui.NOTIFICATION_INFO, time_ms=3000):
    """
