...
SERIE = {
    ...
    "sdbh": {
        ...
        "episodi": 54,
        "verificato": True,
        # Doppiaggio italiano non ne esiste, ma i SOTTOTITOLI italiani si':
        # e' cosi' che l'utente l'ha vista in rete. Kodi e' ora impostato per
        # accenderli da solo quando l'audio non e' in italiano.
        "audio_ita": False,
    ...
    "gundam_08th": {
        "titolo": "Gundam - Il Team Slegar",
        "anni": "1996-1999",
        "episodi": 12,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["prime"],
        "nota": "La guerra di un anno vista da terra, da soldati semplici"
                "invece che da eroi. Sta DENTRO l'originale come tempo: mentre"
                "Amuro combatte nello spazio, qui si fa la guerra nella"
                "giungla.",
    },
    "gundam_0080": {
        "titolo": "Gundam 0080 - Il pericolo di una guerra tascabile",
        "anni": "1989",
        "episodi": 6,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["prime"],
        "nota": "Sei episodi soli, visti dagli occhi di un bambino di undici"
                "anni in una colonia. E' il racconto piu' corto della saga ed"
                "e' quello che quasi tutti indicano come il migliore.",
    },
    "gundam_0083": {
        "titolo": "Gundam 0083 - Stardust Memory",
        "anni": "1991-1992",
        "episodi": 13,
        "verificato": True,
        "audio_ita": True,
        "fonti": [],
        "nota": "Il ponte fra l'originale e Zeta: spiega da dove nasce la"
                "guerra che trovi all'inizio di Zeta Gundam.",
    },
    "lupin4": {
        ...
        "audio_ita": True,
        "fonti": ["prime"],
        "nota": "Girata in Italia, e in Italia e' andata in onda per prima al"
                "mondo. Lupin ha la giacca azzurra.",
    },
    "lupin5": {
        "titolo": "Lupin III - Ritorno alle origini",
        "anni": "2018",
        "episodi": 24,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["prime"],
        "nota": "Ambientata in Francia, giacca blu. Torna il Lupin ladro e"
                "basta, meno buffo e piu' serio.",
    },
    "lupin6": {
        "titolo": "Lupin III - Una storia senza fine",
        "anni": "2021-2022",
        "episodi": 24,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["prime"],
        "nota": "Per i cinquant'anni della serie. Giacca nera.",
    },
    "lupin_fujiko": {
        "titolo": "La donna chiamata Fujiko Mine",
        "anni": "2012",
        "episodi": 13,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["prime"],
        "nota": "Tutto dal punto di vista di Fujiko, con un disegno molto"
                "diverso: ruvido, adulto. E' un antefatto, si puo' guardare per"
                "primo.",
    },
    "ss_soul_of_gold": {
        "titolo": "I Cavalieri dello Zodiaco - Soul of Gold",
        "anni": "2015",
        "episodi": 13,
        "verificato": True,
        "audio_ita": True,
        "fonti": [],
        "nota": "Cosa succede ai cavalieri d'oro DOPO Ade. Va guardata subito"
                "dopo il capitolo di Ade, e' li' che si incastra.",
    },
    "ss_omega": {
        "titolo": "I Cavalieri dello Zodiaco - Omega",
        "anni": "2012-2014",
        "episodi": 97,
        "verificato": True,
        "audio_ita": True,
        "fonti": [],
        "nota": "Una generazione dopo: i protagonisti sono nuovi, i vecchi ci"
                "sono ma come maestri.",
    },
    "ss_lost_canvas": {
        "titolo": "I Cavalieri dello Zodiaco - The Lost Canvas",
        "anni": "2009-2011",
        "episodi": 26,
        "verificato": True,
        "audio_ita": True,
        "fonti": [],
        "nota": "La guerra contro Ade di duecentocinquant'anni prima. Antefatto"
                "vero e proprio: non serve aver visto niente per capirla.",
    },
    "holly_road2002": {
        "titolo": "Holly e Benji Forever - Road to 2002",
        "anni": "2001-2002",
        "episodi": 52,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["infinity"],
        "nota": "Holly gioca in Europa da professionista. E' il seguito che in"
                "Italia e' arrivato per ultimo e che quasi nessuno ha visto per"
                "intero.",
    },
    "ken_blue_sky": {
        "titolo": "Il pugno del cielo blu",
        "anni": "2006",
        "episodi": 46,
        "verificato": True,
        "audio_ita": True,
        "fonti": [],
        "nota": "Shanghai anni Trenta, due generazioni prima di Ken: il"
                "protagonista e' lo zio del suo maestro. Antefatto completo.",
    },
    "lamu2022": {
        "titolo": "Lamu (rifacimento 2022)",
        "anni": "2022-2024",
        "episodi": 46,
        "verificato": True,
        "audio_ita": True,
        "fonti": ["netflix"],
        "nota": "Stessa storia, disegno moderno. Non sostituisce l'originale:"
                "rifa' gli episodi migliori dei 218.",
    },
    "grendizer_u": {
        "titolo": "Grendizer U - Il nuovo Goldrake",
        "anni": "2024",
        "episodi": 13,
        "verificato": True,
        "audio_ita": True,
        "fonti": [],
        "nota": "Rilettura moderna di Goldrake. In Italia sta su RaiPlay,"
                "gratis.",
    },
    "devilman_crybaby": {
        ...
        "audio_ita": True,
        "fonti": ["netflix"],
        "nota": "Il Devilman di Go Nagai rifatto da zero, duro e per adulti:"
                "niente a che vedere con i robot. Su Netflix, doppiato.",
    },
    ...
    "tr_terra_amara": {
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "In Turchia si chiama 'Bir Zamanlar Cukurova'. La piu'"
                "seguita di tutte in Italia: Canale 5 l'ha trasmessa per"
    ...
    "tr_endless_love": {
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "Titolo originale 'Kara Sevda'. Ha vinto l'Emmy"
                "internazionale: e' la serie che ha aperto la strada a tutte"
                "le altre in Europa.",
    },
    "tr_daydreamer": {
        # Gli altri nomi con cui la stessa serie gira in rete: i siti
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "'Erkenci Kus' in originale. Commedia romantica, la piu'"
                "leggera del gruppo.",
    },
    "tr_love_air": {
        # Gli altri nomi con cui la stessa serie gira in rete: i siti
    ...
    "tr_my_home": {
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "'Dogdugun Ev Kaderindir'. Storia dura di una bambina data"
                "via dalla famiglia.",
    },
    "tr_brave": {
        # Gli altri nomi con cui la stessa serie gira in rete: i siti
    ...
    "tr_segreti": {
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "'Yargi'. Giudiziaria: un omicidio che lega un pubblico"
    ...
    "tr_come_sorelle": {
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "'Sevgili Gecmis'. Solo otto puntate: si finisce in una"
                "settimana.",
    },
    "tr_hercai": {
        # Gli altri nomi con cui la stessa serie gira in rete: i siti
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "Su Timvision e Discovery+. Amore e vendetta fra due"
                "famiglie.",
    },
    "tr_ragazza_ufficiale": {
        ...
        "audio_ita": True,
        "fonti": [],
        "nota": "'Kurt Seyit ve Sura'. Storica: la rivoluzione russa vista da"
                "un ufficiale turco.",
    },
    "tr_bitter_sweet": {
        # Gli altri nomi con cui la stessa serie gira in rete: i siti
    ...
    "tr_mezarlik": {
        ...
        "audio_ita": True,
        "fonti": ["netflix"],
        "nota": "Su Netflix, che hai. Poliziesca e cupa, lontana dalle storie"
                "d'amore.",
    },
    "tr_arafta": {
        # Gli altri nomi con cui la stessa serie gira in rete: i siti
        ...
        "sottotitoli_ita": True,
        "fonti": ["youtube"],
        "nota": "ATTENZIONE: questa NON e' doppiata. Esiste solo"
                "sottotitolata in italiano, e si trova su YouTube: e' del"
                "2025 ed e' ancora in corso, un doppiaggio non ha ancora"
...
PERCORSI = {
    ...
    "gonagai": {
        ...
        "segmenti": [
            ...
            ("grande_mazinga", 1, 56),
            ("goldrake",       1, 74),
            # Jeeg era nel catalogo con la sua locandina e i suoi 46 episodi
            # ma non stava in NESSUN percorso: esisteva e non si poteva
            # raggiungere. Va qui: e' del 1975 come Goldrake, stesso autore,
            # stessa stagione televisiva italiana.
            ("jeeg",           1, 46),
            ("devilman_crybaby",  1,  10),
        ],
        "spiegazione": (
    ...
    "tr_terra_amara": {
        "titolo": "Terra amara",
        "sottotitolo": "2018-2022 - 141 puntate",
        "segmenti": [
            ("tr_terra_amara", 1, 141),
        ],
        "spiegazione": (
            "In Turchia si chiama 'Bir Zamanlar Cukurova'. La piu' seguita "
            "di tutte in Italia: Canale 5 l'ha trasmessa per anni, "
            "spostandola di orario di continuo. "
        ),
    },
    "tr_endless_love": {
        "titolo": "Endless Love",
        "sottotitolo": "2015-2017 - 74 puntate",
        "segmenti": [
            ("tr_endless_love", 1, 74),
        ],
        "spiegazione": (
            "Titolo originale 'Kara Sevda'. Ha vinto l'Emmy internazionale: "
            "e' la serie che ha aperto la strada a tutte le altre in "
            "Europa. "
        ),
    },
    "tr_daydreamer": {
        "titolo": "Daydreamer - Le ali del sogno",
        "sottotitolo": "2018-2019 - 51 puntate",
        "segmenti": [
            ("tr_daydreamer", 1, 51),
        ],
        "spiegazione": (
            "'Erkenci Kus' in originale. Commedia romantica, la piu' "
            "leggera del gruppo. "
        ),
    },
    "tr_love_air": {
        "titolo": "Love Is in the Air",
        "sottotitolo": "2020-2021 - 52 puntate",
        "segmenti": [
            ("tr_love_air", 1, 52),
        ],
        "spiegazione": (
    ...
    "tr_my_home": {
        "titolo": "My Home My Destiny",
        "sottotitolo": "2019-2021 - 43 puntate",
        "segmenti": [
            ("tr_my_home", 1, 43),
        ],
        "spiegazione": (
            "'Dogdugun Ev Kaderindir'. Storia dura di una bambina data via "
            "dalla famiglia. "
        ),
    },
    "tr_brave": {
        "titolo": "Brave and Beautiful",
        "sottotitolo": "2016-2017 - 32 puntate",
        "segmenti": [
            ("tr_brave", 1, 32),
        ],
        "spiegazione": (
    ...
    "tr_segreti": {
        "titolo": "Segreti di famiglia",
        "sottotitolo": "2021-2024 - 95 puntate",
        "segmenti": [
            ("tr_segreti", 1, 95),
        ],
        "spiegazione": (
            "'Yargi'. Giudiziaria: un omicidio che lega un pubblico "
            "ministero e un avvocato. Considerata la meglio scritta. "
        ),
    },
    "tr_cherry": {
        "titolo": "Cherry Season - La stagione del cuore",
        "sottotitolo": "2014-2016 - 59 puntate",
        "segmenti": [
            ("tr_cherry", 1, 59),
        ],
        "spiegazione": (
    ...
    "tr_come_sorelle": {
        "titolo": "Come sorelle",
        "sottotitolo": "2019 - 8 puntate",
        "segmenti": [
            ("tr_come_sorelle", 1, 8),
        ],
        "spiegazione": (
            "'Sevgili Gecmis'. Solo otto puntate: si finisce in una "
            "settimana. "
        ),
    },
    "tr_hercai": {
        "titolo": "Hercai - Amore e vendetta",
        "sottotitolo": "2019-2021 - 69 puntate",
        "segmenti": [
            ("tr_hercai", 1, 69),
        ],
        "spiegazione": (
    ...
    "tr_ragazza_ufficiale": {
        "titolo": "La ragazza e l'ufficiale",
        "sottotitolo": "2014 - 21 puntate",
        "segmenti": [
            ("tr_ragazza_ufficiale", 1, 21),
        ],
        "spiegazione": (
            "'Kurt Seyit ve Sura'. Storica: la rivoluzione russa vista da "
            "un ufficiale turco. "
        ),
    },
    "tr_bitter_sweet": {
        "titolo": "Bitter Sweet - Ingredienti d'amore",
        "sottotitolo": "2017 - 26 puntate",
        "segmenti": [
            ("tr_bitter_sweet", 1, 26),
        ],
        "spiegazione": (
    ...
    "tr_forbidden": {
        "titolo": "Forbidden Fruit",
        "sottotitolo": "2018-2023 - 177 puntate",
        "segmenti": [
            ("tr_forbidden", 1, 177),
        ],
        "spiegazione": (
    ...
    "tr_far_away": {
        "titolo": "Far Away",
        "sottotitolo": "2024-2026 - 98 puntate",
        "segmenti": [
            ("tr_far_away", 1, 98),
        ],
        "spiegazione": (
    ...
    "tr_mezarlik": {
        "titolo": "Mezarlik",
        "sottotitolo": "2022-2026 - 20 puntate",
        "segmenti": [
            ("tr_mezarlik", 1, 20),
        ],
        "spiegazione": (
            "Su Netflix, che hai. Poliziesca e cupa, lontana dalle storie "
            "d'amore. "
        ),
    },
    "tr_arafta": {
        "titolo": "Arafta",
        "sottotitolo": "2025-2026 - 129 puntate",
        "segmenti": [
            ("tr_arafta", 1, 129),
        ],
        "spiegazione": (
            "ATTENZIONE: questa NON e' doppiata. Esiste solo sottotitolata "
            "in italiano, e si trova su YouTube: e' del 2025 ed e' ancora "
            "in corso, un doppiaggio non ha ancora fatto in tempo a "
            "esistere. "
        ),
    },
